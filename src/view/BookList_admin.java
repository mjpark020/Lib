...
public class BookList_admin extends JFrame implements ActionListener,MouseListener,KeyListener
{
      // 아이디 찾기
   // Component  목록
      JButton             btnInsert,  btnRefresh,  btnselect,btnbookadd;
      JPanel              topPane;
      ...
      JRadioButton jb0,jb1,jb2,jb3,jb4,jb5,jb6,jb7,jb8,jb9;
      ...
      Bookinpo_admin binpo_a= null;
      
      BookAddPnel bookadd= null;
      ...
      private void initComponent() {
         ...
         this.btnbookadd.addActionListener(this);
	...
	// jTableRefresh - 데이터 새로고침
      ...
      public void mouseClicked(MouseEvent e) {
          ...
          if( binpo_a != null )
        	  binpo_a.dispose();
          binpo_a  = new Bookinpo_admin(bookcode,this);
       }
